...
df_final = pd.read_csv('tipos_de_votos.csv')
df_final['seccion_id'] = df_final['seccion_id'].astype(int)
df_final['tipo'] = df_final['tipo'].astype(int)


#path_data = "data"
#data_name = os.path.join(path_data,'municipios_completo.csv')
name = pd.read_csv('municipios_completo.csv')
rango = pd.DataFrame({'tipo':['1','2','3','4','5','6'],'rango':['16_17','18_29','30_44','45_69','70_85','85omas']})
name['seccion_id'] = name['seccion_id'].astype(int)
rango['tipo'] = rango['tipo'].astype(int)
...
df_anios = pd.read_csv('voto_y_no_voto_anios.csv')
